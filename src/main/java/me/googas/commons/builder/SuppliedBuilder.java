...
public interface SuppliedBuilder<T, O> {
  ...
  /**
   * Build the object or get a default instance using a {@link Supplier} in case that {@link #build(Object)} is null
   *
   * @param t the parameter that takes the builder to build the object
   * @param supplier the supplier of the default instance of the type to build in case that the object built is null
