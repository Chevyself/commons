...
public class ListenerManager {
   ...
   *
   * Using reflection this method will get the class of the object doing a loop for each method.
  ...
  /**
   * Get all the listeners for certain event. The list will be organized by the {@link EventListener#getPriority()}
   *
   ...
   *
   * @param object the listener to unregister, this is the object used to invoke the methods of the listeners
   */
   ...
   * @throws IllegalArgumentException if the parameter cancellable is not an instance of {@link Event}
   */
