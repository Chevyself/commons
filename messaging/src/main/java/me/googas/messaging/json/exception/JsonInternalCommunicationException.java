...
public class JsonInternalCommunicationException extends JsonCommunicationException {
   ...
   */
  public JsonInternalCommunicationException() {}
   ...
   */
  public JsonInternalCommunicationException(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public JsonInternalCommunicationException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.4
   */
  public JsonInternalCommunicationException(Throwable cause) {
    super(cause);
  }
}
