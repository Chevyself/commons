...
/** Thrown when there's been a problem with the execution */
public class JsonExternalCommunicationException extends JsonCommunicationException {

  /**
   * Constructs a new exception with {@code null} as its detail message. The cause is not
   * initialized, and may subsequently be initialized by a call to {@link #initCause}.
   */
  public JsonExternalCommunicationException() {}
   ...
   */
  public JsonExternalCommunicationException(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public JsonExternalCommunicationException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.4
   */
  public JsonExternalCommunicationException(Throwable cause) {
    super(cause);
  }
}
