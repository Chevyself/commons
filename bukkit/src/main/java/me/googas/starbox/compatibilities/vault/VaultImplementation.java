...
public interface VaultImplementation {
   ...
   * @return the player data if found in {@link me.googas.starbox.modules.data.RanksHandler} null
   *     otherwise
   */
  @Nullable
   ...
   * @return the rank if found in {@link me.googas.starbox.modules.data.RanksHandler} null otherwise
   */
  @Nullable
